...
from .models import  Rel_Perfiles_Modulos, Modulos, DetalleModulo, Perfiles, Estado, Detalle_usuarios, Usuarios
...
@receiver(post_save, sender=Detalle_usuarios)
def ejecutar_importar_usuarios(sender, instance, created, **kwargs):
    # Llama el comando personalizado directamente
    call_command('importar_usuarios')
